...
from my_youtube.api import Api, AccessControl, ApiError
from my_youtube.models import video_created, Video
from my_youtube.forms import YoutubeUploadForm, YoutubeDirectUploadForm
...
def video(request, video_id):
    ...
    if availability is not True:
        ...
        if state == "failed" or state == "rejected":
            ...
            return render_to_response(
                "my_youtube/video_unavailable.html",
            ...
            if form.is_valid():
                ...
                if return_only_data:
                    ...
                    try:
                        ...
                        next_url = reverse(
                            "my_youtube.views.video", kwargs={"video_id": video_id})
...
def upload(request):
    ...
    ), reverse("my_youtube.views.upload_return"), os.sep])
    return render_to_response(
        "my_youtube/upload.html",
...
def upload_return(request):
    ...
    if status == "200" and video_id:
        ...
        return HttpResponseRedirect(reverse("my_youtube.views.upload"))
...
def remove(request, video_id):
    ...
    try:
        ...
        next_url = reverse("my_youtube.views.upload")
